#ifndef __AU_EDU_ANU_PME_PME_SPMD_H
#define __AU_EDU_ANU_PME_PME_SPMD_H
...
class PME_SPMD_Strings {
  public:
    static ::x10::lang::String sl__65892;
    static ::x10::lang::String sl__65891;
    static ::x10::lang::String sl__65893;
};

class PME_SPMD : public ::x10::lang::X10Class   {
    public:
    RTT_H_DECLS_CLASS
    ...
    /* Static field: FMGL(timer) */
    static ::au::edu::anu::util::Timer* FMGL(timer);
    static void FMGL(timer__do_init)();
    static void FMGL(timer__init)();
    static volatile ::x10aux::StaticInitController::status FMGL(timer__status);
    static ::x10::lang::CheckedThrowable* FMGL(timer__exception);
    static ::au::edu::anu::util::Timer* FMGL(timer__get)();
    ...
    static ::au::edu::anu::pme::PME_SPMD* _make(::x10::lang::Rail< ::x10x::vector::Vector3d >* edges,
                                                ::x10::lang::Rail< x10_long >* gridSize,
                                                ::x10::regionarray::DistArray< ::x10::lang::Rail< ::au::edu::anu::chem::mm::MMAtom* >*>* atoms,
                                                x10_int splineOrder,
                                                x10_double beta,
    ...
    virtual ::au::edu::anu::pme::PME_SPMD* au__edu__anu__pme__PME_SPMD____this__au__edu__anu__pme__PME_SPMD(
      );
    virtual void __fieldInitializers_au_edu_anu_pme_PME_SPMD(
      );
...
#endif // AU_EDU_ANU_PME_PME_SPMD_H

namespace au { namespace edu { namespace anu { namespace pme { 
class PME_SPMD;
} } } } 

#ifndef AU_EDU_ANU_PME_PME_SPMD_H_NODEPS
#define AU_EDU_ANU_PME_PME_SPMD_H_NODEPS
#include <x10/lang/Long.h>
#include <x10/lang/Double.h>
#include <x10x/vector/Vector3d.h>
#include <x10/lang/Int.h>
...
#include <x10/lang/String.h>
#ifndef AU_EDU_ANU_PME_PME_SPMD_H_GENERICS
#define AU_EDU_ANU_PME_PME_SPMD_H_GENERICS
inline x10_int au::edu::anu::pme::PME_SPMD::FMGL(TIMER_INDEX_TOTAL__get)() {
    return au::edu::anu::pme::PME_SPMD::FMGL(TIMER_INDEX_TOTAL);
}

inline x10_int au::edu::anu::pme::PME_SPMD::FMGL(TIMER_INDEX_GRIDCHARGES__get)() {
    return au::edu::anu::pme::PME_SPMD::FMGL(TIMER_INDEX_GRIDCHARGES);
}

inline x10_int au::edu::anu::pme::PME_SPMD::FMGL(TIMER_INDEX_INVFFT__get)() {
    return au::edu::anu::pme::PME_SPMD::FMGL(TIMER_INDEX_INVFFT);
}

inline x10_int au::edu::anu::pme::PME_SPMD::FMGL(TIMER_INDEX_THETARECCONVQ__get)() {
    return au::edu::anu::pme::PME_SPMD::FMGL(TIMER_INDEX_THETARECCONVQ);
}

inline x10_int au::edu::anu::pme::PME_SPMD::FMGL(TIMER_INDEX_RECIPROCAL__get)() {
    return au::edu::anu::pme::PME_SPMD::FMGL(TIMER_INDEX_RECIPROCAL);
}

inline x10_int au::edu::anu::pme::PME_SPMD::FMGL(TIMER_INDEX_SELF__get)() {
    return au::edu::anu::pme::PME_SPMD::FMGL(TIMER_INDEX_SELF);
}

inline x10_int au::edu::anu::pme::PME_SPMD::FMGL(TIMER_INDEX_DIRECT__get)() {
    return au::edu::anu::pme::PME_SPMD::FMGL(TIMER_INDEX_DIRECT);
}

inline x10_int au::edu::anu::pme::PME_SPMD::FMGL(TIMER_INDEX_PREFETCH__get)() {
    return au::edu::anu::pme::PME_SPMD::FMGL(TIMER_INDEX_PREFETCH);
}

inline x10_int au::edu::anu::pme::PME_SPMD::FMGL(TIMER_INDEX_SETUP__get)() {
    return au::edu::anu::pme::PME_SPMD::FMGL(TIMER_INDEX_SETUP);
}

inline ::au::edu::anu::util::Timer* au::edu::anu::pme::PME_SPMD::FMGL(timer__get)() {
    if (FMGL(timer__status) != ::x10aux::StaticInitController::INITIALIZED) {
        FMGL(timer__init)();
    }
    return au::edu::anu::pme::PME_SPMD::FMGL(timer);
}

#endif // AU_EDU_ANU_PME_PME_SPMD_H_GENERICS
#endif // __AU_EDU_ANU_PME_PME_SPMD_H_NODEPS
