...
void au::edu::anu::mm::FmmLocalData::init(x10_int numTerms, x10_ubyte dMax,
    ...
    this->FMGL(fmmOperators) = (__extension__ ({
        ::au::edu::anu::mm::FmmOperators* alloc__47441 =  (new (::x10aux::alloc_z< ::au::edu::anu::mm::FmmOperators>()) ::au::edu::anu::mm::FmmOperators());
        (alloc__47441)->::au::edu::anu::mm::FmmOperators::_constructor(numTerms,
                                                                       ws);
        alloc__47441;
    }))
    ;
...
::x10::lang::Rail< x10_uint >* au::edu::anu::mm::FmmLocalData::getCombinedUList(
  x10_int ws) {
    ...
    {
        ::x10::util::ListIterator< ::au::edu::anu::mm::LeafOctant*>* octant__47449;
        for (octant__47449 = reinterpret_cast< ::x10::util::ListIterator< ::au::edu::anu::mm::LeafOctant*>*>(this->FMGL(leafOctants)->iterator());
             ::x10::util::ListIterator< ::au::edu::anu::mm::LeafOctant*>::hasNext(::x10aux::nullCheck(octant__47449));
             ) {
            ::au::edu::anu::mm::LeafOctant* octant = ::x10::util::ListIterator< ::au::edu::anu::mm::LeafOctant*>::next(::x10aux::nullCheck(octant__47449));
            ...
            {
                ::au::edu::anu::mm::LeafOctant__UList__UListIterator* mortonId__47447;
                for (mortonId__47447 = reinterpret_cast< ::au::edu::anu::mm::LeafOctant__UList__UListIterator*>(::x10aux::nullCheck(uList)->iterator());
                     mortonId__47447->hasNext(); ) {
                    x10_uint mortonId = mortonId__47447->next();
    ...
    {
        ::x10::lang::Iterator<x10_uint>* mortonId__47451;
        for (mortonId__47451 = combinedUSet->iterator(); ::x10::lang::Iterator<x10_uint>::hasNext(::x10aux::nullCheck(mortonId__47451));
             ) {
            x10_uint mortonId = ::x10::lang::Iterator<x10_uint>::next(::x10aux::nullCheck(mortonId__47451));
...
void au::edu::anu::mm::FmmLocalData::__fieldInitializers_au_edu_anu_mm_FmmLocalData(
    ...
    this->FMGL(octants) = (__extension__ ({
        ...
        //#line 47 "/localdisk/qqiu/workspace/anuchem/apps/fmm/src/au/edu/anu/mm/FmmLocalData.x10"
        ::x10::util::HashMap<x10_uint, ::au::edu::anu::mm::Octant*>* alloc__47442 =
           (new (::x10aux::alloc_z< ::x10::util::HashMap<x10_uint, ::au::edu::anu::mm::Octant*> >()) ::x10::util::HashMap<x10_uint, ::au::edu::anu::mm::Octant*>());
        (alloc__47442)->::x10::util::HashMap<x10_uint, ::au::edu::anu::mm::Octant*>::_constructor();
        alloc__47442;
    }))
    ;
    ...
    this->FMGL(leafOctants) = (__extension__ ({
        ...
        //#line 53 "/localdisk/qqiu/workspace/anuchem/apps/fmm/src/au/edu/anu/mm/FmmLocalData.x10"
        ::x10::util::ArrayList< ::au::edu::anu::mm::LeafOctant*>* alloc__47443 =
           (new (::x10aux::alloc_z< ::x10::util::ArrayList< ::au::edu::anu::mm::LeafOctant*> >()) ::x10::util::ArrayList< ::au::edu::anu::mm::LeafOctant*>());
        (alloc__47443)->::x10::util::ArrayList< ::au::edu::anu::mm::LeafOctant*>::_constructor();
        alloc__47443;
    }))
    ;
    this->FMGL(topLevelOctants) = (__extension__ ({
        ...
        //#line 56 "/localdisk/qqiu/workspace/anuchem/apps/fmm/src/au/edu/anu/mm/FmmLocalData.x10"
        ::x10::util::ArrayList< ::au::edu::anu::mm::Octant*>* alloc__47444 =
           (new (::x10aux::alloc_z< ::x10::util::ArrayList< ::au::edu::anu::mm::Octant*> >()) ::x10::util::ArrayList< ::au::edu::anu::mm::Octant*>());
        (alloc__47444)->::x10::util::ArrayList< ::au::edu::anu::mm::Octant*>::_constructor();
        alloc__47444;
    }))
    ;
    ...
    this->FMGL(timer) = (__extension__ ({
        ...
        //#line 79 "/localdisk/qqiu/workspace/anuchem/apps/fmm/src/au/edu/anu/mm/FmmLocalData.x10"
        ::au::edu::anu::util::Timer* alloc__47445 =  (new (::x10aux::alloc_z< ::au::edu::anu::util::Timer>()) ::au::edu::anu::util::Timer());
        (alloc__47445)->::au::edu::anu::util::Timer::_constructor(
          ((x10_long)11ll));
        alloc__47445;
    }))
    ;
