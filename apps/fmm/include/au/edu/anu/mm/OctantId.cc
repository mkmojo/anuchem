...
x10_int au::edu::anu::mm::OctantId::compareTo(::au::edu::anu::mm::OctantId b) {
    ...
    if ((::x10aux::struct_equals(levelComp, ((x10_int)0)))) {
        ...
        x10_ubyte cX = (__extension__ ({
            ...
            x10_ubyte p__67502 = ((x10_ubyte) (((*this)->FMGL(x)) ^ (b->FMGL(x))));
            x10_ubyte ret__67504;
            
            //#line 58 "/localdisk/qqiu/workspace/anuchem/apps/fmm/src/au/edu/anu/mm/OctantId.x10"
            x10_ubyte i__67551 = ((x10_ubyte)0);
            
            //#line 59 "/localdisk/qqiu/workspace/anuchem/apps/fmm/src/au/edu/anu/mm/OctantId.x10"
            while (((p__67502) > (((x10_ubyte)1)))) {
                p__67502 = ((x10_ubyte) ((p__67502) >> (0x7 & (x10_int)(((x10_long)1ll)))));
                i__67551 = ((x10_ubyte) ((i__67551) + (((x10_ubyte)1))));
            }
        ...
        x10_ubyte cY = (__extension__ ({
            ...
            //#line 57 "/localdisk/qqiu/workspace/anuchem/apps/fmm/src/au/edu/anu/mm/OctantId.x10"
            x10_ubyte p__67506 = ((x10_ubyte) (((*this)->FMGL(y)) ^ (b->FMGL(y))));
            x10_ubyte ret__67508;
            
            //#line 58 "/localdisk/qqiu/workspace/anuchem/apps/fmm/src/au/edu/anu/mm/OctantId.x10"
            x10_ubyte i__67552 = ((x10_ubyte)0);
            
            //#line 59 "/localdisk/qqiu/workspace/anuchem/apps/fmm/src/au/edu/anu/mm/OctantId.x10"
            while (((p__67506) > (((x10_ubyte)1)))) {
                p__67506 = ((x10_ubyte) ((p__67506) >> (0x7 & (x10_int)(((x10_long)1ll)))));
                i__67552 = ((x10_ubyte) ((i__67552) + (((x10_ubyte)1))));
            }
        ...
        x10_ubyte cZ = (__extension__ ({
            ...
            //#line 57 "/localdisk/qqiu/workspace/anuchem/apps/fmm/src/au/edu/anu/mm/OctantId.x10"
            x10_ubyte p__67510 = ((x10_ubyte) (((*this)->FMGL(z)) ^ (b->FMGL(z))));
            x10_ubyte ret__67512;
            
            //#line 58 "/localdisk/qqiu/workspace/anuchem/apps/fmm/src/au/edu/anu/mm/OctantId.x10"
            x10_ubyte i__67553 = ((x10_ubyte)0);
            
            //#line 59 "/localdisk/qqiu/workspace/anuchem/apps/fmm/src/au/edu/anu/mm/OctantId.x10"
            while (((p__67510) > (((x10_ubyte)1)))) {
                p__67510 = ((x10_ubyte) ((p__67510) >> (0x7 & (x10_int)(((x10_long)1ll)))));
                i__67553 = ((x10_ubyte) ((i__67553) + (((x10_ubyte)1))));
            }
...
x10_uint au::edu::anu::mm::OctantId::getMortonId() {
    ...
    x10_uint x__67561 = ((x10_uint) ((*this)->FMGL(x)));
    x10_uint y__67562 = ((x10_uint) ((*this)->FMGL(y)));
    x10_uint z__67563 = ((x10_uint) ((*this)->FMGL(z)));
    x10_uint level__67564 = ((x10_uint) ((*this)->FMGL(level)));
    x10_uint ret__67565;
    
    //#line 78 "/localdisk/qqiu/workspace/anuchem/apps/fmm/src/au/edu/anu/mm/OctantId.x10"
    x10_uint id__67558 = ((x10_uint)0u);
    
    //#line 79 "/localdisk/qqiu/workspace/anuchem/apps/fmm/src/au/edu/anu/mm/OctantId.x10"
    x10_uint bitmask__67559 = ((x10_uint)1u);
    
    //#line 80 "/localdisk/qqiu/workspace/anuchem/apps/fmm/src/au/edu/anu/mm/OctantId.x10"
    x10_int shift__67560 = ((x10_int)0);
    
    //#line 81 "/localdisk/qqiu/workspace/anuchem/apps/fmm/src/au/edu/anu/mm/OctantId.x10"
    {
        x10_long i__67556;
        for (i__67556 = ((x10_long)0ll); ((i__67556) <= (((x10_long)7ll)));
             i__67556 = ((i__67556) + (((x10_long)1ll)))) {
            x10_long i__67557 = i__67556;
            
            //#line 82 "/localdisk/qqiu/workspace/anuchem/apps/fmm/src/au/edu/anu/mm/OctantId.x10"
            id__67558 = ((x10_uint) ((id__67558) | (((x10_uint) ((((x10_uint) ((bitmask__67559) & (z__67563)))) << (x10_int)(0x1f & (((x10_long)((__extension__ ({
                x10_int pre__67554 = shift__67560;
                shift__67560 = ((shift__67560) + (((x10_int)1)));
                pre__67554;
            }))
            )))))))));
            
            //#line 83 "/localdisk/qqiu/workspace/anuchem/apps/fmm/src/au/edu/anu/mm/OctantId.x10"
            id__67558 = ((x10_uint) ((id__67558) | (((x10_uint) ((((x10_uint) ((bitmask__67559) & (y__67562)))) << (x10_int)(0x1f & (((x10_long)((__extension__ ({
                x10_int pre__67555 = shift__67560;
                shift__67560 = ((shift__67560) + (((x10_int)1)));
                pre__67555;
            }))
            )))))))));
            ...
            id__67558 = ((x10_uint) ((id__67558) | (((x10_uint) ((((x10_uint) ((bitmask__67559) & (x__67561)))) << (x10_int)(0x1f & (((x10_long)(shift__67560)))))))));
            
            //#line 85 "/localdisk/qqiu/workspace/anuchem/apps/fmm/src/au/edu/anu/mm/OctantId.x10"
            bitmask__67559 = ((x10_uint) ((bitmask__67559) << (x10_int)(0x1f & (((x10_long)1ll)))));
        }
    }
    
    //#line 87 "/localdisk/qqiu/workspace/anuchem/apps/fmm/src/au/edu/anu/mm/OctantId.x10"
    id__67558 = ((x10_uint) ((id__67558) | (((x10_uint) ((level__67564) << (x10_int)(0x1f & (((x10_long)24ll))))))));
    
    //#line 89 "/localdisk/qqiu/workspace/anuchem/apps/fmm/src/au/edu/anu/mm/OctantId.x10"
    ret__67565 = id__67558;
...
x10_uint au::edu::anu::mm::OctantId::getMortonId(x10_uint x, x10_uint y, x10_uint z,
    ...
    {
        x10_long i__67568;
        for (i__67568 = ((x10_long)0ll); ((i__67568) <= (((x10_long)7ll)));
             i__67568 = ((i__67568) + (((x10_long)1ll)))) {
            x10_long i__67569 = i__67568;
            
            //#line 82 "/localdisk/qqiu/workspace/anuchem/apps/fmm/src/au/edu/anu/mm/OctantId.x10"
            id = ((x10_uint) ((id) | (((x10_uint) ((((x10_uint) ((bitmask) & (z)))) << (x10_int)(0x1f & (((x10_long)((__extension__ ({
                x10_int pre__67566 = shift;
...
::au::edu::anu::mm::OctantId au::edu::anu::mm::OctantId::getFromMortonId(
  x10_uint mortonId) {
    ...
    {
        x10_long i__67576;
        for (i__67576 = ((x10_long)0ll); ((i__67576) <= (((x10_long)7ll)));
             i__67576 = ((i__67576) + (((x10_long)1ll)))) {
            x10_long i__67577 = i__67576;
    ...
    ::au::edu::anu::mm::OctantId alloc__67578 =  ::au::edu::anu::mm::OctantId::_alloc();
    
    //#line 26 "/localdisk/qqiu/workspace/anuchem/apps/fmm/src/au/edu/anu/mm/OctantId.x10"
    x10_ubyte x__67572 = ((x10_ubyte) (x));
    x10_ubyte y__67573 = ((x10_ubyte) (y));
    x10_ubyte z__67574 = ((x10_ubyte) (z));
    x10_ubyte level__67575 = ((x10_ubyte) (level));
    
    //#line 27 "/localdisk/qqiu/workspace/anuchem/apps/fmm/src/au/edu/anu/mm/OctantId.x10"
    alloc__67578->FMGL(x) = x__67572;
    alloc__67578->FMGL(y) = y__67573;
    alloc__67578->FMGL(z) = z__67574;
    alloc__67578->FMGL(level) = level__67575;
...
x10_uint au::edu::anu::mm::OctantId::getLeafMortonId() {
    ...
    {
        x10_long i__67581;
        for (i__67581 = ((x10_long)0ll); ((i__67581) <= (((x10_long)7ll)));
             i__67581 = ((i__67581) + (((x10_long)1ll)))) {
            x10_long i__67582 = i__67581;
            
            //#line 122 "/localdisk/qqiu/workspace/anuchem/apps/fmm/src/au/edu/anu/mm/OctantId.x10"
            id = ((x10_uint) ((id) | (((x10_uint) ((((x10_uint) ((bitmask) & (z)))) << (x10_int)(0x1f & (((x10_long)((__extension__ ({
                x10_int pre__67579 = shift;
                shift = ((shift) + (((x10_int)1)));
                pre__67579;
            }))
            )))))))));
...
x10_uint au::edu::anu::mm::OctantId::getLeafMortonId(::x10x::vector::Point3d atomCentre,
    ...
    {
        x10_long i__67585;
        for (i__67585 = ((x10_long)0ll); ((i__67585) <= (((x10_long)7ll)));
             i__67585 = ((i__67585) + (((x10_long)1ll))))
        {
            x10_long i__67586 = i__67585;
            
            //#line 140 "/localdisk/qqiu/workspace/anuchem/apps/fmm/src/au/edu/anu/mm/OctantId.x10"
            id = ((x10_uint) ((id) | (((x10_uint) ((((x10_uint) ((bitmask) & (z)))) << (x10_int)(0x1f & (((x10_long)((__extension__ ({
                x10_int pre__67583 = shift;
                shift = ((shift) + (((x10_int)1)));
                pre__67583;
            }))
            )))))))));
...
::au::edu::anu::mm::OctantId au::edu::anu::mm::OctantId::getParentId(
    ...
    ::au::edu::anu::mm::OctantId alloc__67591 =  ::au::edu::anu::mm::OctantId::_alloc();
    
    //#line 26 "/localdisk/qqiu/workspace/anuchem/apps/fmm/src/au/edu/anu/mm/OctantId.x10"
    x10_ubyte x__67587 = ((x10_ubyte) (((*this)->FMGL(x)) / ::x10aux::zeroCheck(((x10_ubyte)2))));
    x10_ubyte y__67588 = ((x10_ubyte) (((*this)->FMGL(y)) / ::x10aux::zeroCheck(((x10_ubyte)2))));
    x10_ubyte z__67589 = ((x10_ubyte) (((*this)->FMGL(z)) / ::x10aux::zeroCheck(((x10_ubyte)2))));
    x10_ubyte level__67590 = ((x10_ubyte) (((*this)->FMGL(level)) - (((x10_ubyte)1))));
    
    //#line 27 "/localdisk/qqiu/workspace/anuchem/apps/fmm/src/au/edu/anu/mm/OctantId.x10"
    alloc__67591->FMGL(x) = x__67587;
    alloc__67591->FMGL(y) = y__67588;
    alloc__67591->FMGL(z) = z__67589;
    alloc__67591->FMGL(level) = level__67590;
...
::au::edu::anu::mm::OctantId au::edu::anu::mm::OctantId::getAnchor(
  x10_ubyte dMax) {
    ...
    ::au::edu::anu::mm::OctantId alloc__67596 =  ::au::edu::anu::mm::OctantId::_alloc();
    
    //#line 26 "/localdisk/qqiu/workspace/anuchem/apps/fmm/src/au/edu/anu/mm/OctantId.x10"
    x10_ubyte x__67592 = ((x10_ubyte) (((*this)->FMGL(x)) << (0x7 & (x10_int)(((x10_long)(shift))))));
    x10_ubyte y__67593 = ((x10_ubyte) (((*this)->FMGL(y)) << (0x7 & (x10_int)(((x10_long)(shift))))));
    x10_ubyte z__67594 = ((x10_ubyte) (((*this)->FMGL(z)) << (0x7 & (x10_int)(((x10_long)(shift))))));
    x10_ubyte level__67595 = dMax;
    
    //#line 27 "/localdisk/qqiu/workspace/anuchem/apps/fmm/src/au/edu/anu/mm/OctantId.x10"
    alloc__67596->FMGL(x) = x__67592;
    alloc__67596->FMGL(y) = y__67593;
    alloc__67596->FMGL(z) = z__67594;
    alloc__67596->FMGL(level) = level__67595;
...
::x10::lang::String* au::edu::anu::mm::OctantId::toString(
    ...
    return ::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus((&::au::edu::anu::mm::OctantId_Strings::sl__68534), (*this)->FMGL(level)), (&::au::edu::anu::mm::OctantId_Strings::sl__68535)), (*this)->FMGL(x)), (&::au::edu::anu::mm::OctantId_Strings::sl__68536)), (*this)->FMGL(y)), (&::au::edu::anu::mm::OctantId_Strings::sl__68536)), (*this)->FMGL(z)), (&::au::edu::anu::mm::OctantId_Strings::sl__68537));
...
::x10::lang::String au::edu::anu::mm::OctantId_Strings::sl__68534("");
::x10::lang::String au::edu::anu::mm::OctantId_Strings::sl__68535(":(");
::x10::lang::String au::edu::anu::mm::OctantId_Strings::sl__68537(")");
::x10::lang::String au::edu::anu::mm::OctantId_Strings::sl__68536(",");
