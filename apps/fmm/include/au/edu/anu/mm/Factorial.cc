...
void au::edu::anu::mm::Factorial::FMGL(factorial__do_init)() {
    ...
    ::x10::lang::Rail< x10_double >* __var21__ = ::au::edu::anu::mm::Factorial::calcFact();
    FMGL(factorial) = __var21__;
...
::x10::lang::Rail< x10_double >* au::edu::anu::mm::Factorial::calcFact() {
    ...
    {
        x10_long i__24456;
        for (i__24456 = ((x10_long)1ll); ((i__24456) <= (((x10_long)99ll)));
             i__24456 = ((i__24456) + (((x10_long)1ll)))) {
            x10_long i__24457 = i__24456;
            fact->x10::lang::Rail< x10_double >::__set(i__24457, ((((x10_double) (i__24457))) * (fact->x10::lang::Rail< x10_double >::__apply(
                                                                                                   ((i__24457) - (((x10_long)1ll)))))));
        }
    }
...
void au::edu::anu::mm::Factorial::_constructor() {
    ::au::edu::anu::mm::Factorial* this__24458 = this;
