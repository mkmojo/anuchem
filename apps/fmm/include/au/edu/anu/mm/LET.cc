...
void au::edu::anu::mm::LET::_constructor(::x10::lang::Rail< x10_uint >* combinedUList) {
    ...
    ::au::edu::anu::mm::LET* this__64115 = this;
    ...
    this->FMGL(multipoleCopies) = (__extension__ ({
        ::x10::util::HashMap<x10_uint, ::au::edu::anu::mm::MultipoleExpansion*>* alloc__54991 =
        ...
        (alloc__54991)->::x10::util::HashMap<x10_uint, ::au::edu::anu::mm::MultipoleExpansion*>::_constructor(
